...
Idempotency also protects ordering.
...
Can idempotency work with acks=0?

Answer:

No.

The producer never receives confirmation and cannot reliably determine retry behavior.
